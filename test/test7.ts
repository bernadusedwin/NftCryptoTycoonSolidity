...
//                 {
//                     console.log("bank balance after send campaign");
//                     const trx1 = await trainTycoon.bankBalances(address1);
//                     // console.log("sentinels0", trx1);
//                     // expect(trx1).to.equal(100 * 10 ** 18);
//                     expect(trx1).to.equal(BigNumber.from("10000000000000000000"));
//                     // expect(trx1).to.equal(BigNumber.from(100 * 10 ** 18));
//                     // BigNumber.from("10000000000000000000")
//                 }

//                 {
//                     console.log("upgrade weapon");
//                     const trx1 = await trainTycoon.connect(addr1).upgradeWeapon(1);
//                     await trx1.wait();
//                 }

//                 {
//                     console.log("bank balance after upgrade weapon");
//                     const trx1 = await trainTycoon.bankBalances(address1);
//                     // console.log("sentinels0", trx1);
//                     // expect(trx1).to.equal(99000000000000000000);
//                     expect(trx1).to.equal(BigNumber.from("9900000000000000000"));
//                 }

//                 {
//                     const trx1 = await trainTycoon.getTokenSentinel(1);
//                     // console.log("sentinels0", trx1);
//                     expect(trx1.weaponTier).to.equal(1);
//                 }
