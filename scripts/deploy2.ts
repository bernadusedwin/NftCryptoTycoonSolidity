...
async function main() {
  ...
  const trainAddress = "0xA51c1fc2f0D1a1b8494Ed1FE312d7C3a78Ed91C0";
  const ercAddress = "0x0DCd1Bf9A1b36cE34237eEaFef220932846BCD82";
  ...
  const trainTycoon = new ethers.Contract(trainAddress, trainAbi.abi, signer);
